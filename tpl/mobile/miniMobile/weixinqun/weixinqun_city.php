...
<link rel="canonical" href="<?=url('@weixinqun_city@',['id'=>$data['id']],$site_url)?>">
{%end%}

{%block@article%}
<?php if($cityParent): //上级城市?>
    <div class="yang-bread f30 pl1"><a href="/">首页</a> &gt <a href="<?=url('@weixinqun_city@',['id'=>$cityParent['id']])?>"><?=$cityParent['name'];?></a> &gt <?=$city['name'];?></div>
<?php endif;?>
...
<div class="yang-city w73 m1 color8 t-c clearfix f28">
    <?php foreach ($cityChildren as $child)://下级城市?>
        <a class="w22 h8 mr1 ml1 pt2 pb2 mb1 radius0 fl bg-color-info color8" href="<?=url('@weixinqun_city@',['id'=>$child['id']])?>"><?=$child['name'];?></a>
    <?php endforeach;?>
</div>
<?php endif;?>
<?php if($data):?>
