        ...
        'caiji'=>[
            'comment'=> [
                ...
                'rule'=>[
                    'type'=>'regex,map',
                    'remak'=>'',
                    'selector'=>'%<ul>(?P<area>[\s\S]+?)</ul>%',
                    'tags'=>[
                        'username'=>'%<div class="school_pl_name">(?P<username>[\s\S]+?)</div>%',
                        'shijian'=>'%<div class="school_pl_hueiyh fl">评论时间:(?P<shijian>[\d:\- ]+)</div>%',
                        'content'=>'%<div class="school_pl_main">(?P<content>[\s\S]+?)<div class="school_pl_zf">%'
                    ],
                    'cut'=>'<div class="school_pl_list">{%|||%}<div class="cl_l_b">'
                ],
                //是否开启循环匹配
                'isLoop'=>true,
                //是否开启多分页采集
