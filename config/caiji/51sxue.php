...
return [
    ...
    'content'=>[
        ...
        'caiji'=>[
            ...
            'content'=> [
                ...
                'notEmpty'=>false,
                //采集链接合成
                'getUrl'=>'tags{%|||%}http://xuexiao.51sxue.com/content/id_{%from_id%}.html',
                //为采集时的规则
                'rule'=>[
                    'type'=>'regex,cut',
                    'remak'=>'',
                    'selector'=>'<div class="nr_m">{%|||%}<div class="nr_ws_nr">',
                    'tags'=>''//type=regex必填
                ],
                //是否开启循环匹配
                'isLoop'=>false,
            ...
            'phone'=>[
                ...
                'rule'=>[
                    'type'=>'regex,cut',
                    'remak'=>'',
                    'selector'=>'<ol class=school_lx_text id=phone>电话:<b>{%|||%}</b></ol>',
                    'tags'=>''//type=regex必填
                ],
                'isLoop'=>false,
                'isMultipage'=>false,
            ...
            'address'=>[
                ...
                'rule'=>[
                    'type'=>'regex,cut',
                    'remak'=>'',
                    'selector'=>'<ol class=school_lx_text id=address>地址:{%|||%}</ol>',
                    'tags'=>''//type=regex必填
                ],
                'isLoop'=>false,
                'isMultipage'=>false,
           ...
           /*'thumb'=>[
                ...
                'notEmpty'=>false,
               //采集链接合成
               'getUrl'=>'tags{%|||%}http://xuexiao.51sxue.com/photo/index/s_{%from_id%}.html',
               //为采集时的规则
               'rule'=>[
                   'type'=>'regex,single',
                   'selector'=>'%<p class="img_border">\s*<a [^>]+>\s*<img src="(?P<thumb>[^"]+)"%',
            ...
            'photo'=>[
                ...
                'notEmpty'=>false,
                //采集链接合成
                'getUrl'=>'tags{%|||%}http://xuexiao.51sxue.com/index.php?app=photo&act=index&id={%from_id%}',
                //为采集时的规则
                'rule'=>[
                    'type'=>'regex,multi',
                    'selector'=>'%<img src="(?P<photo>[^"]+)"[^>]+>%',
                    'tags'=>'photo',//type=regex必填
                    'cut'=>'<ul class="ad-thumb-list">{%|||%}</ul>'
                ],
                'isLoop'=>true,
                'isMultipage'=>false,
                'filter'=>[
    ...
    'fabu'=>[
        'run_max'=>mt_rand(400,500),//每次发布的条数，0表示不限制
        'plug'=>[],//插件
        'target'=>'http://www.iweixinqun.cn/weixinqun/fabu/xuexiao?pwd=Djidksl$$EER4ds58cmO', //发布的目标
        'fields'=>'update_time,create_time,diqu_type,diqu_p,more,diqu',
        'where1'=>' WHERE isfabu=0 and iscaiji=1 and isdownload=1',
        'where2'=> [['isfabu','eq',0],['iscaiji','eq',1],['isdownload','eq',1]],
        'http'=>[
            'curl'=>[
                'tryTimes'=>3,
                'login'=>false,
