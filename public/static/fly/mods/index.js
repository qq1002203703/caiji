...
//layui.define(['layer', 'laytpl', 'form', 'element', 'upload'], function(exports){
  ...
  var fly = {
      ...
      return $.ajax({
        ...
        success: function(res){
          if(res.code === 0) {
            ...
            layer.confirm(res.msg || res.code,{anim: 5,title:"提示"});
    ...
    ,sendAuthCode: function(options){
      ...
      btn.on('click', function(){
        ...
        ,value = elemPhone.val() //手机号或邮箱
        ,elemImagecode = options.elemImagecode
        ,valueImage = elemImagecode.val(); //图形码
        ...
        fly.json(options.url, {
          ...
          layer.msg('验证码已发送至你的'+(options.type=='phone' ? '手机' :'邮箱')+'，请注意查收', {
            icon: 1
            ,shade: 0
          });
  ...
  $('.fly-search').on('click', function(){
    layer.open({
      ...
      ,content: ['<form action="http://cn.bing.com/search" id="mysearch">'
      ...
      ,success: function(layero){
        ...
        layero.find('form').submit(function(){
          ...
          input.val(input.val() + ' site:uuhuihui.com');
      });
      }
    })
  });
