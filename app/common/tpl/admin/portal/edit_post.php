							...
							<div class="tab-item" id="tab-a">
								<table class="full pure-table pure-table-bordered">
									<tr>
										...
										<td>
											<input id="catename" class="pure-input-1" type="text" value="<?=$data['catename']?>" name="catename" placeholder="选择分类" required>
											<input id="cateid" type="hidden" name="cateid" value="<?=$data['cateid']?>">
										</td>
									...
									<tr>
										...
										<td colspan="2">
											...
											<select id="pay_type" class="pure-select dh-inline" name="pay_type">
												<option value="0"<?=echo_select($data['pay_type'],0)?>>免费</option>
												<option value="1"<?=echo_select($data['pay_type'],1)?>>金币</option>
												<option value="2"<?=echo_select($data['pay_type'],2)?>>金钱</option>
											</select>&nbsp;&nbsp;
