    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
        ...
        <div class="layui-tab-content" style="padding: 20px 0;">
            <div class="layui-tab-item layui-show">
                <form class="layui-form ayui-form-pane" method="post" action="<?=url('api/caiji_admin/queue_add');?>" id="form-main">
                    <div class="layui-form-item">
                        <label class="layui-form-label">任务说明</label>
                        <div class="layui-input-inline">
                            <input  id="description"  class="layui-input" type="text" name="description" value="">
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input id="run_time" class="layui-input datetime-input" name="run_time" type="text" value="" lay-verify="required" required>
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input id="callback" class="layui-input" name="callback" type="text" value="" lay-verify="required" required>
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input id="class_param" class="layui-input" name="class_param" type="text" value="">
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input id="method_param" class="layui-input" name="method_param" type="text" value="">
                        </div>
