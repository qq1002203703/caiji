    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form" method="post" action="<?=url('api/caiji_admin/page_add')?>" id="form-main">
                    <div class="layui-form-item">
                        <label class="layui-form-label">名称 <span class="red">*</span></label>
                        <div class="layui-input-inline">
                            <input class="layui-input" type="text" name="name" value="" lay-verify="required" required>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea class="layui-textarea" type="text" name="url" lay-verify="required" required></textarea>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea class="layui-textarea" type="text" name="options"></textarea>
