    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
        ...
        <div class="layui-tab-content" style="padding: 20px 0;">
            <div class="layui-form layui-tab-item layui-show">
                <form class="layui-form layui-form-pane" method="post" action="<?=url('api/video_admin/category_add');?>" enctype="multipart/form-data" id="content_form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input class="layui-input" type="text" name="name" id="name" required lay-verify="required" value="">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="seo_keywords" id="keywords" value="" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item" pane>
                        ...
                        <div class="layui-input-inline">
                            ...
                            <input type="radio" name="status" value="0" title="暂时隐藏" >
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="slug" id="filename" value="" class="layui-input" >
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="list_tpl" autocomplete="off" value="" class="layui-input" >
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="content_tpl" autocomplete="off" value="" class="layui-input" >
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline" style="width: 300px;">
                            <img id="thumb-logo" style="max-width: 100%;" src="/uploads/images/notpic.gif">
                        </div>
                        <div class="layui-input-inline" style="width: 300px;">
                            <div id="thumb-container"></div>
                            <div style="clear: both"><p class="upload-count text-center">已上传 <span id="upload-count">0</span> 张图片</p></div>
                        </div>
                    </div>
...
<script type="text/javascript">
    var navSidebar="video-category";
    var currentData={
        id:0, //当前文档的id，如果没有就设为0
        type:"video", //频道种类：'article' 'soft','goods'
