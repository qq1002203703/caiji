...
<div class="fly-panel fly-panel-user" pad20>
        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-form">
                <p style="font-size:13px;">
                    <a class="layui-btn" href="<?=url('admin/video/category_add')?>">添加分类</a>
                    <a id="update-cache" class="layui-btn" href="javascript:;" ac="<?=url('api/video_admin/category_cache')?>" confirm="false">更新缓存</a>
                </p>

                <form method="post" action="<?=url('api/video_admin/category_multi_action')?>" name="form2" id="form2">
    ...
    <script type="text/javascript">
        ...
        var currentData={id:0,type:"video"};
    </script>
{%end%}
    ...
    <script type="text/javascript">
        layui.use(['layer','form','fly'], function() {
            ...
            $("a[id^='deletea']").on('click', function(){
                ...
                $(this).attr('ac',"<?=url('api/video_admin/category_del')?>?id="+ac);
                fly.ajaxClick(this);
                return false;
            });
            //编辑一条
            $("a[id^='edita_']").on('click', function(){
                ...
                $(this).attr('href',"<?=url('admin/video/category_edit')?>?id="+ac);
                //fly.ajaxClick(this);
                return true;
            });
            //更新缓存
