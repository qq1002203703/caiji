...
<div class="slider">
    <div class="unslider" id="unslider01">
        <ul>
            <li><img src="http://zsqos.xin/component_library/img/banner_01.jpg" alt="广告图"/></li>
            <li><img src="http://zsqos.xin/component_library/img/banner_02.jpg" alt="广告图"/></li>
            <li><img src="http://zsqos.xin/component_library/img/banner_03.jpg" alt="广告图"/></li>
            <li><img src="http://zsqos.xin/component_library/img/banner_04.jpg" alt="广告图"/></li>
            <li><img src="http://zsqos.xin/component_library/img/banner_05.jpg" alt="广告图"/></li>
        </ul>
    </div>
</div>
