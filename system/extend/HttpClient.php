...
/**
 * 原项目地址：https://github.com/urmaul/httpclient
...
class HttpClient
{
    public $useragent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Safari/537.36';
    /**
     ...
     * @throws \Exception when "tofile" is defined and file is not writeable.
     */
     ...
     * @param array $params request params.
     * @return boolean true when file is downloaded and false if downloading failed.
     * @throws \Exception when $dest file is not writeable.
     */
    ...
    public function request($params)
    {
        ...
        do {
            ...
            $res === FALSE && $params['attempts_max'] != 0 && sleep($params['attempts_delay']) !== FALSE
        );
        if ( isset($tofile) ) {
            fclose($tofile);
            if ($res === FALSE)
